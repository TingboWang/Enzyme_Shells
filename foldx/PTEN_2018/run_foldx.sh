...
cd /share/home/wangtb/enzyme_shells/foldx/PTEN_2018

mkdir -p logs
mkdir -p results_all

TASK_ID=$SLURM_ARRAY_TASK_ID
MUT_FILE="/share/home/wangtb/enzyme_shells/foldx/mutants/PTEN_2018/mut_list_${TASK_ID}.txt"
...
cp /share/home/wangtb/enzyme_shells/structure/PTEN_2018.pdb ${TEMP_DIR}/
