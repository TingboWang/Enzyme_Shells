...
cd /lustre/home/tbwang/EnzymeShells/Enzyme_Shells/foldx/AMIE

mkdir -p logs
mkdir -p results_all

TASK_ID=$SLURM_ARRAY_TASK_ID
MUT_FILE="/lustre/home/tbwang/EnzymeShells/Enzyme_Shells/foldx/mutants/AMIE/mut_list_${TASK_ID}.txt"
...
cp /lustre/home/tbwang/EnzymeShells/Enzyme_Shells/structure/AMIE.pdb ${TEMP_DIR}/
