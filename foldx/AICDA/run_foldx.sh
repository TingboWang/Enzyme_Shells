...
cd /share/home/wangtb/enzyme_shells/foldx/AICDA

mkdir -p logs
mkdir -p results_all

TASK_ID=$SLURM_ARRAY_TASK_ID
MUT_FILE="/share/home/wangtb/enzyme_shells/foldx/mutants/AICDA/mut_list_${TASK_ID}.txt"
...
cp /share/home/wangtb/enzyme_shells/structure/AICDA.pdb ${TEMP_DIR}/
