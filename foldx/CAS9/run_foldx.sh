...
cd /share/home/wangtb/enzyme_shells/foldx/CAS9

mkdir -p logs
mkdir -p results_all

TASK_ID=$SLURM_ARRAY_TASK_ID
MUT_FILE="/share/home/wangtb/enzyme_shells/foldx/mutants/CAS9/mut_list_${TASK_ID}.txt"
...
cp /share/home/wangtb/enzyme_shells/structure/CAS9.pdb ${TEMP_DIR}/
