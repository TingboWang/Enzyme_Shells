#!/bin/bash
#SBATCH --job-name=FX_CAS9
#SBATCH --partition=cu-1
#SBATCH --array=1-163
#SBATCH --output=logs/foldx_%A_%a.out
#SBATCH --error=logs/foldx_%A_%a.err

cd /lustre/home/tbwang/EnzymeShells/Enzyme_Shells/foldx/CAS9

mkdir -p logs
mkdir -p results_all

TASK_ID=$SLURM_ARRAY_TASK_ID
MUT_FILE="/lustre/home/tbwang/EnzymeShells/Enzyme_Shells/foldx/mutants/CAS9/mut_list_${TASK_ID}.txt"
...
cp /lustre/home/tbwang/EnzymeShells/Enzyme_Shells/structure/CAS9.pdb ${TEMP_DIR}/
