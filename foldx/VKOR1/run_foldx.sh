...
cd /share/home/wangtb/enzyme_shells/foldx/VKOR1

mkdir -p logs
mkdir -p results_all

TASK_ID=$SLURM_ARRAY_TASK_ID
MUT_FILE="/share/home/wangtb/enzyme_shells/foldx/mutants/VKOR1/mut_list_${TASK_ID}.txt"
...
cp /share/home/wangtb/enzyme_shells/structure/VKOR1.pdb ${TEMP_DIR}/
